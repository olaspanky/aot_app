...
export const { useLoginMutation, useRegisterMutation, useVerifyUserMutation, useResendOtpMutation,  
  useRequestPasswordResetMutation, useResetPasswordMutation, useGetDashboardDataQuery ,  useGetDashboardQuery, 
  useGetPromoCodesQuery, useCreatePromotionMutation, useGetFAQsQuery, useCreateFAQMutation, useGetUserDetailsQuery,
  useLazyGetUserDetailsQuery, useCreateUserMutation, useActivateUserMutation, useDeleteUserMutation, useGetPromoCodeByIdQuery, 
  useUpdatePromoCodeMutation, useGetSupportDataQuery, useGetDisputesQuery, useLazyGetAdminDisputeByIdQuery, useBookOrderMutation, 
  useWalletQuery, useMakeCardPaymentMutation, useGetTrackingOrdersQuery, useGetCustomerDeliveryQuery, useCreateDisputeMutation, useDeleteAdminPromoCodeMutation, useGetRidersVerificationQuery, useLazyGetRidersVerificationQuery} = api;
